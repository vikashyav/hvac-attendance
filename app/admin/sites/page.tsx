    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-3xl p-8 max-h-[99vh] overflow-auto">
            <DialogHeader>
              <DialogTitle>Add New Job Site</DialogTitle>
              <DialogDescription>Enter the job site details below</DialogDescription>
            </DialogHeader>
            <ScrollArea >
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">{site.client}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="font-medium">{site.employees} employees</span>
                      </div>
                    </div>
                    <div>
